...
class SearchScreenContratante extends StatefulWidget {
  ...
  @override
  _NotificacionesContratanteScreenState createState() => _NotificacionesContratanteScreenState();
}

class _NotificacionesContratanteScreenState extends State<SearchScreenContratante> {
  ...
  Future<void> _cargarNotificaciones() async {
    try {
      ...
      final notificaciones = await _notificacionesService.obtenerNotificacionesContratante(widget.specificId);
  ...
  Future<void> _marcarTodasComoLeidas() async {
    try {
      await _notificacionesService.marcarTodasLeidasContratante(widget.specificId);
